...
public class TestPlayer {
   ...
   */
  @Test(expected = IllegalArgumentException.class) public void testPlayerInvalidBirthYear() {
   ...
   */
  @Test(expected = IllegalArgumentException.class) public void testPlayerInvalidBirthMonth() {
   ...
   */
  @Test(expected = IllegalArgumentException.class) public void testPlayerInvalidBirthDay() {
   ...
   * allowed range.
   */
  @Test(expected = IllegalArgumentException.class) public void testPlayerInvalidSkillLevel() {
   ...
   * allowed range.
   */
  @Test(expected = IllegalArgumentException.class) public void testPlayerInvalidSkillLevel2() {
   ...
   * invalid.
   */
  @Test(expected = IllegalArgumentException.class) public void testPlayerInvalidPreferredPosition() {

...
/**
 * This interface represents the methods offered by a player in a game of soccer. it represents a
 * player in a game of soccer.
 */
public interface Player {
  ...
  /**
   * get the player's skill level based on the coach's assessment. Skill level is between 1 and 5 (1
   * = lowest skill level, 5 = highest skill level)
   *

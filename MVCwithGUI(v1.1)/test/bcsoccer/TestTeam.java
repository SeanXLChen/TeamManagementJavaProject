...
public class TestTeam {
  ...
  @Before public void setUp() {
    ...
    firstTeam.addPlayer("S", "Chen", 2015, 8, 26, "Goalie", 5);
    firstTeam.addPlayer("B", "Bob", 2015, 8, 26, "Goalie", 4);
    firstTeam.addPlayer("J", "Smith", 2015, 8, 26, "Midfielders", 3);
    firstTeam.addPlayer("A", "Ana", 2015, 8, 26, "Forward", 2);
    firstTeam.addPlayer("C", "Don", 2015, 8, 26, "Goalie", 4);
    firstTeam.addPlayer("D", "Ethan", 2015, 8, 26, "Goalie", 3);
    firstTeam.addPlayer("E", "Frank", 2015, 8, 26, "Forward", 4);
    firstTeam.addPlayer("C", "Gothic", 2015, 8, 26, "Midfielders", 3);
    firstTeam.addPlayer("A", "Hugh", 2015, 8, 26, "Forward", 5);
    firstTeam.addPlayer("G", "Ian", 2015, 8, 26, "Forward", 1);
    firstTeam.addPlayer("H", "Jen", 2015, 8, 26, "Goalie", 2);
    firstTeam.addPlayer("I", "Kathy", 2015, 8, 26, "Forward", 2);

    secondTeam = new TeamImpl();
    secondTeam.addPlayer("S", "Chen", 2015, 8, 26, "Goalie", 5);
    secondTeam.addPlayer("B", "Bob", 2015, 8, 26, "Goalie", 3);
  }
   ...
   */
  @Test
      (expected = IllegalArgumentException.class) public void testAddPlayerOverAgeLimit() {
    firstTeam.addPlayer("S", "Chen", 2012, 8, 1, "Goalie", 5);
  }

  /**
   * Test the addPlayer method with invalid year input. all inputs error are already tested inside
   * TestGetDateOfBirth class
   */
  @Test
      (expected = IllegalArgumentException.class) public void testAddPlayerYearTooLow() {
    firstTeam.addPlayer("S", "Chen", 1000, 8, 26, "Goalie", 5);
  }
   ...
   */
  @Test
      (expected = IllegalStateException.class) public void
  testGenerateStartingLineupNotEnoughPlayers() {
